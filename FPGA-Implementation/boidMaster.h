 ...
 * boidMaster.h
 * 
 * This is the header file for the BoidMaster FPGA core. The BoidMaster is a 
 ...
 * in boidMaster.cpp to aid readability of the source code. The #defines in 
 * this file are supposed to be identical to those in boidCPU.h and boids.h. 
...
// TODO: Should this guard not be __BOIDMASTER_H_?
...
typedef ap_int<12> uint12;  // For simulation width and height
